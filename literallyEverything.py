                ...
                if game['game_type'] == "R":
                    ...
                    if isGameLogged is False:
                        ...
                        g.execute('update "Games Logged" set "Away Score" = ?, "Home Score" = ?, "Innings" = ?, "Status" = ?, "Winning Team" = ?, "Losing Team" = ?, "Winning Pitcher" = ?, "Losing Pitcher" = ?, "Save Pitcher" = ? where "Game ID" = ?',
                            (game['away_score'], game['home_score'], game['current_inning'], game['status'], game['winning_team'], game['losing_team'], game['winning_pitcher'], game['losing_pitcher'], game['save_pitcher'], gameId))
                    gl.commit()
                    print("=============================================================")
                else:
